...
/*-----
import React from 'react';
import { View, Button, StyleSheet, Linking, Alert, ImageBackground } from 'react-native';
import * as Location from 'expo-location';
...
const MainPage = ({ navigation }) => {
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Button title="Foot Patrol" onPress={handleCallFootPatrol} />
        <Button title="Quick Question" onPress={() => navigation.navigate('QuickQuestion')} />
        <Button
        title="Foot Patrol"
        onPress={handleCallFootPatrol}
      />
